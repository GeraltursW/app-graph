...
qqRoot.images = ['qq_demo_001.svg', 'qq_demo_002.svg', 'qq_demo_003.svg'];
qqRoot.action.popupAction.push({ id: 'qq-home-search', label: '打开搜索', action_type: 'tap', popup_name: '全局搜索面板', description: '首页顶部搜索入口' });
qqRoot.action.stateAction.push({ id: 'qq-home-dnd', label: '消息免打扰', action_type: 'tap', state_key: 'dnd_enabled', state_value: true, description: '切换消息提醒状态' });
qqRoot.action.externalAction.push({ id: 'qq-home-scan', label: '扫一扫', action_type: 'tap', target: 'system_camera', description: '调用系统相机扫码' });

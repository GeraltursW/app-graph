...
import { graphNodeBox as NODE_BOX } from "../info.data";
...
<template>
  <section ref="graphArea" class="graph-area">
    <div class="canvas-stats" aria-label="图谱统计">
      ...
      <div class="stat"><span>状态</span><strong>{{ loading ? "加载中" : "在线" }}</strong></div>
    </div>
    <GraphButton
    ...
    >
      <template #icon>
        <Icon :icon="compactMode ? 'ant-design:appstore-outlined' : 'ant-design:compress-outlined'" :size="14" />
      </template>
